				...
				<div className="relative h-screen">
					<div className="container mx-auto px-4 h-full flex items-center justify-center flex-col relative">
						<img
							...
							height={300}
							alt="vital vision"
							className="mx-auto top-0 left-0 right-0 bottom-0 absolute"
						/>
						<div className="max-w-xl md:max-w-3xl text-center text-white-800 ">
							...
							<p className="text-2xl mb-6 [text-outline] text-white">
								<div className="sd">
									Experience immersive, engaging, and effective therapy from the
									comfort of your home
								</div>
							</p>
							<button className="bg-blue-600 hover:bg-blue-700 py-2 px-4 rounded-lg text-white text-2xl">
								<Link href="/admin">Try It Now</Link>
							</button>
						</div>
					</div>
				</div>
